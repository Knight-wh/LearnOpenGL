...
int main()
{
  ...
  // -------------------------
  Shader rayShader(
    "D:/Files/master/Study-Course/learnopengl/LearnOpenGL/data/shaders/Miscellaneous/ray_tracer.comp"
  );

  Shader quadShader(
    "D:/Files/master/Study-Course/learnopengl/LearnOpenGL/data/shaders/Miscellaneous/quad_shader.vert",
    "D:/Files/master/Study-Course/learnopengl/LearnOpenGL/data/shaders/Miscellaneous/quad_shader.frag"
  );
  ...
  // step1: creating the texture / image
  ...
  // in order to write to a texture, use image storing functions
  glBindImageTexture(0, tex_output, 0, GL_FALSE, 0, GL_WRITE_ONLY, GL_RGBA32F);

  // step2: Determining the work group size
  {
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    // this func will stop the execution of the host program at this point 
